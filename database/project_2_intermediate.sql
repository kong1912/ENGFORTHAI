...
CREATE TABLE `intermediate` (
  `id_intermediate` int NOT NULL,
  `word` varchar(45) NOT NULL,
  PRIMARY KEY (`id_intermediate`),
  UNIQUE KEY `id_intermediate_UNIQUE` (`id_intermediate`)
...
INSERT INTO `intermediate` VALUES (1,'injure'),(2,'unique'),(3,'adult'),(4,'currency'),(5,'giraffe');
...
-- Dump completed on 2022-03-13  6:08:11
